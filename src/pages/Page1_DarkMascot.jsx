...
import Studio3DBotMascot from "../components/mascots/Studio3DBotMascot";

export default function Page1_DarkMascot() {
  ...
  // Dynamic mascot message matching reference image states
  const mascotSubtitle = success
    ? "Let's compile something awesome! 🚀"
    : passwordFocused
    ? passwordVisible
      ? "Okay... I can see it! 👀"
          ...
          >
            ...
            >
              ...
              <h1 style={{ color: "#ffffff", fontFamily: "Space Grotesk", fontSize: "clamp(32px, 3.8vw, 44px)", fontWeight: 500, margin: "4px 0 0" }}>
                Code & compile
                <br />
                <strong style={{ color: "#22c55e", fontWeight: 700 }}>with SwaplyBot.</strong>
              </h1>
            </motion.div>

            {/* Official 3D Studio Rendered Swaply Mascot */}
            <Studio3DBotMascot
            ...
            {/* Live Interactive Subtitle Matching Reference Artwork */}
            <motion.p
              style={{
                minHeight: 28,
                margin: "12px 0 0",
          ...
          <div className="form-wrapper" style={{ width: "100%", maxWidth: 390, margin: "0 auto" }}>
            ...
            <form className="login-form" onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: 22 }}>
              ...
              <div className="field" style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <label htmlFor="dark-email" style={{ color: "#cbd5e1", fontSize: 13, fontWeight: 600 }}>
                  Developer Email
                </label>
                <div
              ...
              <div className="field" style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <div className="password-label" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <label htmlFor="dark-password" style={{ color: "#cbd5e1", fontSize: 13, fontWeight: 600 }}>
                    Master Key / Password
                  </label>
                  <button
                    type="button"
