...
import FoxPandaMascot from "../components/mascots/FoxPandaMascot";
import "../styles/LoginPage.css";

export default function Page3_FoxPanda() {
  ...
  return (
    ...
    >
      <div className="ambient ambient-one" style={{ borderColor: "rgba(234, 88, 12, 0.1)" }} />
      ...
      >
        ...
        >
          ...
          <div className="character-content">
            ...
            >
              <span>TURBO CODE RUNNER</span>
              <h1>
                Build fast with
                <br />
                <strong style={{ color: "#ea580c" }}>Pip the fox.</strong>
              </h1>
            </motion.div>
            ...
            <motion.p className="character-message" animate={{ opacity: 1 }}>
              {success
                ? "Turbo Compiler Activated! 🦊✨"
                : passwordFocused
                ? passwordVisible
                  ? "Pip can see your key 👀"
                  : "No peeking at the secret 🙈"
                : "Pip is ready to transpile your project."}
            </motion.p>
          </div>
        ...
        <section className="form-panel">
          <div className="form-wrapper">
            ...
            >
              ...
              <h2>Sign in</h2>
              <p>Enter your details to access the turbo compiler cloud.</p>
            </motion.div>

            <form className="login-form" onSubmit={handleSubmit} noValidate>
              {/* Email */}
              <div className="field">
                <label htmlFor="fox-email">Email address</label>
                <div
              ...
              <div className="field">
                <div className="password-label">
                  <label htmlFor="fox-password">Password</label>
                  <button
                    type="button"
