...
import HighQuality3DThreeBot from "../components/mascots/HighQuality3DThreeBot";

export default function Page1_ThreeJSBot() {
  ...
  const mascotSubtitle = success
    ...
    ? passwordVisible
      ...
      : "I don't peek! Hands covering visor 🙈"
    : emailFocused
    ? "Tracking your email in 3D... 🔍"
    : "Three.js 3D Robot ready to compile 😊";
  ...
  return (
    <main
      ...
      style={{
        ...
        padding: "32px",
        background: `
          radial-gradient(circle at 15% 15%, rgba(34, 197, 94, 0.14), transparent 38%),
          radial-gradient(circle at 85% 80%, rgba(6, 182, 212, 0.1), transparent 38%),
          #080c10
        `,
        color: "#f8fafc",
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: 32,
          overflow: "hidden",
          boxShadow: "0 30px 80px rgba(0, 0, 0, 0.85), 0 0 60px -10px rgba(34, 197, 94, 0.25)",
      ...
      >
        ...
        <section
          ...
          style={{
            ...
            background: "linear-gradient(150deg, rgba(18, 26, 36, 0.95) 0%, rgba(8, 12, 18, 0.98) 100%)",
        ...
        >
          <div className="brand" style={{ color: "#fff", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontFamily: "Space Grotesk", fontSize: 18, fontWeight: 700 }}>SwaplyThree</span>
          </div>
          ...
          >
            ...
            >
              <span style={{ color: "#86efac", fontSize: 12.5, fontWeight: 700, letterSpacing: "1.2px" }}>
                REAL 3D THREE.JS WEBGL BOT
              </span>
              <h1 style={{ color: "#ffffff", fontFamily: "Space Grotesk", fontSize: "clamp(30px, 3.6vw, 42px)", fontWeight: 500, margin: "4px 0 0" }}>
                Compile native
                <br />
                <strong style={{ color: "#22c55e", fontWeight: 700 }}>in Real-Time 3D.</strong>
              </h1>
            </motion.div>

            {/* High Quality Three.js 3D Bot */}
            <HighQuality3DThreeBot
          ...
          <div className="panel-footer" style={{ display: "flex", alignItems: "center", gap: 9, color: "#64748b", fontSize: 12 }}>
            <span>Hardware Accelerated PBR</span>
          ...
          <div className="form-wrapper" style={{ width: "100%", maxWidth: 390, margin: "0 auto" }}>
            ...
            >
              ...
              <p style={{ color: "#94a3b8", fontSize: 14, margin: 0 }}>
                Enter your credentials to launch your 3D compiler workspace.
              </p>
            </motion.div>
            ...
            <form className="login-form" onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div className="field" style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <label htmlFor="three-email" style={{ color: "#cbd5e1", fontSize: 13, fontWeight: 600 }}>
                  Developer Email
                </label>
                <div
              ...
              <div className="field" style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <div className="password-label" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <label htmlFor="three-password" style={{ color: "#cbd5e1", fontSize: 13, fontWeight: 600 }}>
            ...
            >
              Don't have a developer seat? <strong style={{ color: "#22c55e" }}>Deploy node</strong>
            </button>
          </div>
