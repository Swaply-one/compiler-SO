...
import MatchaFrogMascot from "../components/mascots/MatchaFrogMascot";
import "../styles/LoginPage.css";

export default function Page4_MatchaFrog() {
    ...
    <main
      ...
      style={{
        background: `
          ...
          radial-gradient(circle at 85% 80%, rgba(234, 179, 8, 0.08), transparent 30%),
          #f6faf6
        `,
      }}
    >
      <div className="ambient ambient-one" style={{ borderColor: "rgba(34, 197, 94, 0.15)" }} />
      <div className="ambient ambient-two" style={{ borderColor: "rgba(234, 179, 8, 0.12)" }} />
      ...
      >
        ...
        <section
          ...
          style={{
            background: "linear-gradient(150deg, #ecfdf5 0%, #d1fae5 50%, #bbf7d0 100%)",
          }}
        >
          <div className="brand">
            <div
              ...
              style={{
                ...
                boxShadow: "0 5px 14px rgba(34, 197, 94, 0.3)",
                color: "#fff",
              }}
            >
              <Smile size={19} />
            </div>
            <span>SwaplyFrodo</span>
          </div>
          ...
          <div className="character-content">
            ...
            >
              <span>FRODO THE MATCHA FROG</span>
              <h1>
                Compile cheerful
                <br />
                <strong style={{ color: "#16a34a" }}>with Frodo Frog.</strong>
              </h1>
            </motion.div>
            ...
            <motion.p className="character-message" animate={{ opacity: 1 }}>
              {success
                ? "Frodo is celebrating! Ribbit 🐸✨"
                : passwordFocused
                ? passwordVisible
                  ? "Frodo is peeking through fingers 👀"
                  : "Frodo has eyes closed polite 🙈"
                : "Frodo is excited to run your build."}
            </motion.p>
          </div>

          <div className="panel-footer">
            <span>Lilypad Compiler</span>
        ...
        <section className="form-panel">
          <div className="form-wrapper">
            ...
            <form className="login-form" onSubmit={handleSubmit} noValidate>
              {/* Email */}
              <div className="field">
                <label htmlFor="frog-email">Email address</label>
              ...
              <div className="field">
                <div className="password-label">
                  <label htmlFor="frog-password">Password</label>
                  <button
                    type="button"
