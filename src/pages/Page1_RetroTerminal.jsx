...
import RetroTerminalMascot from "../components/mascots/RetroTerminalMascot";
import "../styles/LoginPage.css";

export default function Page1_RetroTerminal() {
  ...
  return (
    <main
      ...
      style={{
        background: `
          ...
          radial-gradient(circle at 85% 80%, rgba(56, 189, 248, 0.08), transparent 30%),
          #0b0f17
        `,
        color: "#f8fafc",
      }}
    >
      ...
      <div className="ambient ambient-two" style={{ borderColor: "rgba(56, 189, 248, 0.12)" }} />
      ...
      >
        ...
        >
          ...
          <div className="character-content">
            ...
            >
              <span style={{ color: "#4ade80" }}>RETRO TERMINAL BOT</span>
              <h1 style={{ color: "#fff" }}>
                Compile native
                <br />
                <strong style={{ color: "#22c55e" }}>with Byte Terminal.</strong>
              </h1>
            </motion.div>
            ...
            <motion.p className="character-message" style={{ color: passwordFocused ? "#4ade80" : "#94a3b8" }} animate={{ opacity: 1 }}>
              {success
                ? "Floppy loaded! Welcome back 💾✨"
                : passwordFocused
                ? passwordVisible
                  ? "CRT phosphor screen detecting key 👀"
                  : "CRT screen covered politely 🙈"
                : "Byte is warming up the compiler cathode ray."}
            </motion.p>
          </div>
        ...
        <section className="form-panel" style={{ background: "rgba(11, 15, 23, 0.98)" }}>
          <div className="form-wrapper">
            ...
            >
              ...
              <p style={{ color: "#94a3b8" }}>Enter your credentials to launch compiler terminal.</p>
            </motion.div>

            <form className="login-form" onSubmit={handleSubmit} noValidate>
              {/* Email */}
              <div className="field">
                <label htmlFor="byte-email" style={{ color: "#cbd5e1" }}>Email address</label>
                <div
              ...
              <div className="field">
                <div className="password-label">
                  <label htmlFor="byte-password" style={{ color: "#cbd5e1" }}>Password / Key</label>
                  <button
                    type="button"
            ...
            >
              Don't have a terminal key? <strong style={{ color: "#22c55e" }}>Create terminal</strong>
            </button>
          </div>
